 ...
 */
export interface Slide<Props = Record<string, unknown>> {
  /**
 ...
 */
export interface CarouselEngine<T> {
  /**
 ...
 */
export interface CarouselConfig<T = Record<string, unknown>> {
  /**
 ...
 */
export interface CarouselEventEmitter {
 ...
 */
export interface CarouselAdapter<T> {
  /**
   ...
   * @returns {CarouselConfig} The transformed carousel data, including slides, carousel metadata, and other necessary details.
   */
  (modelData: Record<T>): CarouselConfig<T>;
}
